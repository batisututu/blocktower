...
Current puzzle tuning (2026-09-25): [The refinement record](docs/implementation/Piece_Tray_Refinement_2026-09-25.md) lowers single-piece weight for new personal saves and future issued weekly challenges, retains the classic profile for existing saves/challenges, and hides the waiting-piece tray panel. The version 10 QA app passed the Android screen and challenge-submit checks after device unlock.
Phase 4 recovery follow-up (2026-09-25): [The recovery/conflict record](docs/implementation/Phase4_Recovery_Conflict_2026-09-25.md) covers a hashed recovery code, bearer-token rotation, server-accepted trace restore, explicit conflict archive/selection, version 14 QA device checks, and 147 tests / 3,777 assertions. The production app remains version 8 on device. Public TLS deployment, operational controls, full backup restore procedures, verifier version retention and broader device/time-boundary checks remain open.
