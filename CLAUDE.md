...
Phase 4 local MVP work (2026-09-25): [ADR-0008](docs/adr/0008-phase4-verified-weekly-challenge.md) and the [online contract](game/scripts/core/contracts/online_phase4_contract.md) define a separate guest weekly challenge, UTC cutoff, full action replay, prefix-only updates, and read-only verified tower viewing. The implementation record is [here](docs/implementation/Phase4_Online_MVP_2026-09-25.md). No Phase 4 Android installation or server end-to-end verification has been completed; do not treat this as release-ready online ranking.
