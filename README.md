...
The Phase 3 building MVP includes a condensed whole-tower view, an enlarged ten-floor view, and atomic single-target appearance copying between completed segments. It preserves the `bt_session_v2` save schema and bounds the overview diagram to 64 bands regardless of tower height. The pinned Godot 4.7.2 suite passes 138 tests / 3,705 assertions; 46 separate-process save checks and 13 Windows native screens / 120 checks pass. Windows 30/300/3,000-floor redraw measurements are recorded. Android device and human observation acceptance remain open. See the [Phase 3 desktop record](docs/implementation/Phase3_Desktop_Validation_2026-09-25.md).
