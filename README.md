...
Phase 4 local MVP work (2026-09-25): [Online implementation record](docs/implementation/Phase4_Online_MVP_2026-09-25.md) adds a server-replayed weekly challenge, guest account, verified leaderboard, and read-only representative tower viewing. The personal offline save remains separate. Server and device end-to-end validation and release operations remain open.
