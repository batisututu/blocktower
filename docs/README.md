...
기준일: 2026-09-25. 아래 문서들이 현재 기획·정책·가이드·검증의 기준이다. 파일명은 고정하고 문서 안의 개정 번호를 갱신한다. 과거 버전과 검토 원문은 backup에서만 보관한다.
...
**Phase 3 건축 MVP:** [전체 탑 감상·단일 구간 복사 기록](implementation/Phase3_MVP_Tower_Overview_Copy_2026-09-25.md)과 [데스크톱 보완·검증](implementation/Phase3_Desktop_Validation_2026-09-25.md). 작은 화면의 구간 확대와 작은 재질 비중 표기를 보완했다. 고정 GUT 138개/3,705개 단언, 별도 프로세스 저장 46개 점검, Windows 화면 13종/120개 점검 및 30/300/3,000층 호스트 계측이 통과했다. Android 실기기·사람 관찰 및 D08 기기 예산 판정은 남아 있다.
