...
게임 기획 §36의 Phase 3 관문 전체를 통과했다고 판정하지 않는다. D08의 최소 기기·메모리·프레임 예산이 아직 확정되지 않았고, 최신 소스 Android 실기기 측정과 사람의 첫 30층 이해·가독성 관찰은 앞선 사용자 요청에 따라 미뤄 두었다. 전체 적용/대량 복사·일괄 되돌리기는 현재 단일 대상 MVP 범위 밖이다.
